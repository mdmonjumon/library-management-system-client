                        ...
                        <form onSubmit={handleAddBook}>
                            <fieldset className="fieldset space-y-5">
                                ...
                                <div className="fieldset relative">
                                    ...
                                    <input type="date" name="releaseDate" className="input focus-within:outline-0 w-full" />
                                </div>
                                ...
                                {/* description */}
                                <div>
                                    <textarea name="description" className="textarea w-full focus-within:outline-0" placeholder="Description"></textarea>
                                </div>
